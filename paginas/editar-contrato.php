...
//Dados da query
$query = "UPDATE `contratos` SET `titulo` = '{$titulo}', `descricao` = '{$descricao}', `gestor` = '{$gestor}', `setor_id` = '{$setor}', `vencimento` = '{$vencimento}', `inicio` = '{$inicio}', `valor` = '{$valor}', `numero` = '{$numero}' WHERE `contratos`.`contrato_id` = {$id}";
//Enviando Arquivos
