        ...
        <section class="col-lg-7 connectedSortable ui-sortable"> <!-- Coluna Esquerda -->
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-red">
              ...
              <h5 class="widget-user-desc">Condepe Fidem</h5>
            </div>
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                <li><a href="../#">Contratos<span class="pull-right badge bg-blue"><?= $contratosusuario ?></span></a></li>
                <li><a href="../#">Contratos Expirados<span class="pull-right badge bg-red"><?= contaNotificacoes(); ?></span></a></li>
                <li></li>
                <li></li>
              </ul>
            </div>
