...
<div class="wrapper" style="height: auto; min-height: 100%;">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-mini"><b>CD</b>P</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>CONDEPE</b>/FIDEM</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo $_SESSION['nome_usuario']?> - Web Developer
            ...
            <form class="form-horizontal" action="adiciona-contrato.php" enctype="multipart/form-data" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="numero" placeholder="000/0000" name="numero">
                  </div>
                </div>
            <!--Input Descrição-->
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="3" placeholder="Descrição ..." id="desc" name="descricao"></textarea>
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" id="inicio" name="inicio" >
                  </div>
                </div>    
                  <!--Input Vencimento-->
                  <div class="form-group">
